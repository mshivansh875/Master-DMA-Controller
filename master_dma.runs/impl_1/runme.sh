...
HD_PWD='G:/My Drive/engineering/Digital Electronics/ichip/master_dma/master_dma/master_dma.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log master_dma.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source master_dma.tcl -notrace
