...
HD_PWD='G:/My Drive/engineering/Digital Electronics/ichip/master_dma/master_dma/master_dma.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log master_dma.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source master_dma.tcl
